        ...
        for train in trains:
            ...
            if inFront[0][1] != target and inFront[0][1] != 'X':
                if len(inFront) == 2:
                    ...
                    if inFront[0][1] == opponent and inFront[1][1] == 'X':
                        attack.append(train)
                    if inFront[0][1] == opponent and inFront[1][1] == opponent and inFront[2][1] == 'X':
                        longAttack.append(train)
                    if inFront[1][1] == 'E' or inFront[1][1] == 'X' or inFront[1][1] == opponent:
                        if inFront[2][1] == 'E' or inFront[2][1] == 'X':
                            trainsYouCanMove.append(train)
    return trainsYouCanMove,attack,longAttack
...
def moves(board, target):
    ...
    if len(movableThreeMarblesTrains[2]) != 0:
        for train in movableThreeMarblesTrains[2]:
            longAttack.append(train)
    elif len(movableThreeMarblesTrains[1]) != 0:
